    ...
    <article className="py-12">
      <div className="container-editorial max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink mb-2">{article.title}</h1>
        ...
        <div className="mt-8 flex flex-wrap gap-2">
          {article.tags.map((tag) => (
            <span key={tag} className="text-xs text-ink-light bg-surface border border-border px-2 py-1 rounded-full transition-colors hover:text-accent hover:border-accent">
              #{tag}
            </span>
          ))}
        </div>
